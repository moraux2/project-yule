...
idCVar pm_thirdPersonRange(			"pm_thirdPersonRange",		"40",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "camera distance from player in 3rd person" );
idCVar pm_thirdPersonHeight(		"pm_thirdPersonHeight",		"-16",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "height of camera from normal view height in 3rd person" );
...
idCVar pm_thirdPersonRight(			"pm_thirdPersonRight",		"16",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "offset of the third person camera to the player's right." );
...
idCVar pm_thirdPerson(				"pm_thirdPerson",			"1",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_BOOL, "enables third person view" );
