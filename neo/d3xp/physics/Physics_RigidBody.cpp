...
//	current.i.angularMomentum -= current.pushVelocity.SubVec3( 1 ) * inertiaTensor;
	...
	if( gameLocal.mpGame.IsGametypeCoopBased() && ( IEEE_FLT_IS_NAN( next.i.angularMomentum.x ) || IEEE_FLT_IS_NAN( next.i.angularMomentum.y ) || IEEE_FLT_IS_NAN( next.i.angularMomentum.z ) ||
			IEEE_FLT_IS_NAN( next.i.angularMomentum.x ) || IEEE_FLT_IS_NAN( next.i.angularMomentum.y ) || IEEE_FLT_IS_NAN( next.i.angularMomentum.z ) ) )
	{
